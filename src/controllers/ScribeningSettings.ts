...
export type ScribeningSettings = typeof DEFAULT_SETTINGS;
export type SettingKey = keyof typeof DEFAULT_SETTINGS;

export class ScribeningSettingTab extends PluginSettingTab {
    plugin: ScribeningPlugin;

    private readonly shouldResetTimeWhenReinvoked = true;

    constructor(app: App, plugin: ScribeningPlugin) {
        super(app, plugin);
        this.plugin = plugin;
    ...
    debounceApplySettingsUpdate = debounce(
        ...
        200,
        this.shouldResetTimeWhenReinvoked
    );
