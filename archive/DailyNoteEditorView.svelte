<script lang="ts">
    ...
    import type { TimeRange, SortField, SelectionMode } from "../types/time.t";
    ...
    export let timeField: SortField = "mtime"; // 默认使用修改时间
    ...
    $: if (
        ...
        (selectedRange !== fileManager.options.timeRange ||
            ...
            timeField !== fileManager.options.sortField)
    ) {
...
<div class="daily-note-view">
    ...
    {#if selectionMode === "daily" && !fileManager?.hasCurrentDayNote() && (selectedRange === "all" || selectedRange === "week" || selectedRange === "month" || selectedRange === "year" || selectedRange === "quarter")}
        ...
        <div class="dn-blank-day" on:click={createNewDailyNote}>
